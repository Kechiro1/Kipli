  ...
  return (
    <div className="wrapper flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="w-3/4 flex flex-col items-center md:items-start    gap-2">
        <h1 className="text-5xl font-bold text-white">Kipli Group</h1>
        ...
        <p className="text-base tracking-wide text-center md:text-left">
         Turn your concept into a digital reality. Our five-person team is ready to build your dream website quickly, efficiently, and to the highest quality standards.
        </p>
      </div>
    </div>
  );
